...
Se genera un modelo de regresión logística entrenado con el 80% de los datos originales, para predecir si una muestra cobraría menos de 50K euros al año, y se comprueba que algunos de los valores de las variables explicativas no afectan al resultado de la previsión (aquellos cuyo p-value > 0.05)
