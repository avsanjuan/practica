...
Género masculino, Raza blanca, politicos, casados y directivos son los colectivos que mayor salario anual tienen.
...
El modelo es capaz de predecir el suelto de una mujerm raza negra con 24 años de edad, 9 años de educación y 40 horas semanales en 34.97K anuales.
Se genera un modelo de regresión logística entrenado con el 80% de los datos originales, para predecir si una muestra cobraría menos de 50K euros al año, y se comprueba que algunos de los valores de las variables explicativas no afectan al resultadode la previsión (aquellos cuyo p-value > 0.05)
Este modelo tiene una exactitud del 92%
