...
ResulTS<-cbind(mediaTest(Fs,Ms))
ResulTS
adult.m <-subset(adult, gender == 'Male',  select = c(income) )
adult.f <-subset(adult, gender == 'Female',  select = c(income) )
results2 <- test.contraste(adult.f,adult.m)
results2
...
ResulTS<-cbind(mediaTest(Ws,Bs, d0=6450))
ResulTS
var.test(x=Ws,y=Bs)
